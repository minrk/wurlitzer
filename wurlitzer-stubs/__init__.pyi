...
class Wurlitzer:
    ...
    def __init__(
        self,
        stdout: (
            SupportsWrite[str] | SupportsWrite[bytes] | logging.Logger | None
        ) = None,
        stderr: (
            _STDOUT | SupportsWrite[str] | SupportsWrite[bytes] | logging.Logger | None
        ) = None,
        encoding: str | None = ...,
        bufsize: int | None = ...,
    ) -> None: ...
...
class _LogPipe(io.BufferedWriter):
    ...
    level: int
    def __init__(
        self, logger: logging.Logger, stream_name: str, level: int = 20
    ) -> None: ...
